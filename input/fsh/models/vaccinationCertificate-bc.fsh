Instance: vaccinationCertificateBC
InstanceOf: StructureDefinition
Description: "Logical Model representing the EU Digital Green Certificate for Border Control"
Title: "EU Digital Green Certificate - Border Control"
Usage: #definition

* publisher = "HL7 Italia"
* status = #draft
* url = "http://hl7.it/fhir/dgc/StructureDefinition/vaccinationCertificateBC"
* name = "vaccinationCertificateBorderControl"
* title = "EU Digital Green Certificate - Border Control"
* status = #draft
* experimental = true
* description = "Logical Model representing the EU Digital Green Certificate for Border Control"
