...
Alias: $ec-drug = https://ec.europa.eu/health/documents/community-register/html/
Alias: $ec-temp-vaccine = http://ec.europa.eu/temp/vaccineproductname
Alias: $ec-temp-vaccine-manufacturer = http://ec.europa.eu/temp/vaccinemanufacturer
